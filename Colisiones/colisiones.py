...
background = pygame.image.load(path.join(img_dir, "Bg/Background-0.jpg")).convert()
background_rect = background.get_rect()
player_img = pygame.image.load(
    path.join(img_dir, "Naves/playerShip1_orange.png")
).convert()
meteor_img = pygame.image.load(
    path.join(img_dir, "Meteors/meteorBrown_med1.png")
).convert()
